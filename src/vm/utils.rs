...
impl VirtualMachine {
    ...
    #[inline]
    pub fn get_0_args(&self, actual_args: usize) -> RuntimeResult<()> {
        self.get_n_args::<0>(actual_args).map(|_| ())
    }

    #[inline]
    pub fn get_1_args(&self, actual_args: usize) -> RuntimeResult<ObjectHandle> {
        self.get_n_args::<1>(actual_args).map(|args| args[0])
    }

    #[inline]
    pub fn get_2_args(&self, actual_args: usize) -> RuntimeResult<(ObjectHandle, ObjectHandle)> {
        self.get_n_args::<2>(actual_args).map(|args| (args[0], args[1]))
    }

    #[inline]
    pub fn get_3_args(&self, actual_args: usize) -> RuntimeResult<(ObjectHandle, ObjectHandle, ObjectHandle)> {
        self.get_n_args::<3>(actual_args).map(|args| (args[0], args[1], args[2]))
    }

    #[inline]
    pub fn get_4_args(&self, actual_args: usize) -> RuntimeResult<(ObjectHandle, ObjectHandle, ObjectHandle, ObjectHandle)> {
        self.get_n_args::<4>(actual_args).map(|args| (args[0], args[1], args[2], args[3]))
    }

    #[inline]
    pub fn get_5_args(&self, actual_args: usize) -> RuntimeResult<(ObjectHandle, ObjectHandle, ObjectHandle, ObjectHandle, ObjectHandle)> {
